...
var connection_waterfall = mysql.createConnection({
    host : 'localhost',
    user : 'root',
    password : 'AGR670A4',
    port : '3306',
...
var waterfallSmallGapArray = [];
function getWaterfallSmallGapArray(){
    sqlSentence = 'SELECT * FROM share_gap ORDER BY min_rate ASC LIMIT 800';
...
function start(){
    ...
    async.parallel([
        ...
        if(err){
            ...
            console.log('calculate share finished');
        }
